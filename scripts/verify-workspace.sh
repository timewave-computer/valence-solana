...
EXPECTED_MEMBERS=(
    ...
    "sdk"
    "tests/integration"
    "tests/integration/shard"
    "tests/integration/functions/test_function"
)
...
echo "2. All programs have proper Cargo.toml files"
echo "3. Test infrastructure is properly configured"
echo ""
