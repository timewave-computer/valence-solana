...
rec {
  ...
  workspaceMembers = {
    ...
    "registry-workflow-example" = rec {
      packageId = "registry-workflow-example";
      build = internal.buildRustCrateWithFeatures {
        packageId = "registry-workflow-example";
      };
    ...
    "valence-functions" = rec {
      packageId = "valence-functions";
      build = internal.buildRustCrateWithFeatures {
        packageId = "valence-functions";
      };
    ...
    "valence-registry" = rec {
      packageId = "valence-registry";
      build = internal.buildRustCrateWithFeatures {
        packageId = "valence-registry";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "agave-feature-set" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "1iga9dkbcfcx80l5h33vzvspxci8qc3fw8l3ps6zq0jj1y6w4al4";
      ...
      "agave-reserved-account-keys" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0qlp8k4qg7qr400q9cb8h0s7hp58al00r9rqppgn0nbb0yrl3yhs";
      ...
      "anchor-spl" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "spl-associated-token-account 6.0.0";
            optional = true;
          ...
          {
            name = "spl-token";
            packageId = "spl-token 7.0.0";
            optional = true;
            features = [ "no-entrypoint" ];
          }
          {
            name = "spl-token-2022";
            packageId = "spl-token-2022 6.0.0";
            optional = true;
            features = [ "no-entrypoint" ];
          }
          {
            name = "spl-token-group-interface";
            packageId = "spl-token-group-interface 0.5.0";
            optional = true;
          }
          {
            name = "spl-token-metadata-interface";
            packageId = "spl-token-metadata-interface 0.6.0";
            optional = true;
          }
        ];
        features = {
      ...
      "async-compression" = rec {
        ...
        version = "0.4.27";
        edition = "2018";
        sha256 = "1s0l81yxckazg1zs3kqhhj3i4ss4p822hqcic3p3rq2advb3kffx";
      ...
      "feels-core" = rec {
        crateName = "feels-core";
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./feels/feels-core; };
        libName = "feels_core";type = [ "cdylib" "lib" ];
        dependencies = [
          {
            name = "anchor-lang";
            packageId = "anchor-lang";
      ...
      "feels-math" = rec {
        crateName = "feels-math";
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./feels/feels-math; };
        libName = "feels_math";type = [ "cdylib" "lib" ];
        dependencies = [
          {
            name = "anchor-lang";
            packageId = "anchor-lang";
      ...
      "feels-verifiers" = rec {
        crateName = "feels-verifiers";
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./feels/feels-verifiers; };
        libName = "feels_verifiers";type = [ "cdylib" "lib" ];
        dependencies = [
          {
            name = "anchor-lang";
            packageId = "anchor-lang";
      ...
      "registry-workflow-example" = rec {
        crateName = "registry-workflow-example";
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./examples/registry-workflow; };
        libName = "registry_workflow_example";
        authors = [
      ...
      "solana-account-decoder" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0ig9bcvhqrd0zbrqs5gckzywql9cnzlk5alf4wwvp829sfvykn0k";
        ...
        dependencies = [
          ...
          {
            name = "spl-token";
            packageId = "spl-token 8.0.0";
            features = [ "no-entrypoint" ];
          }
          {
            name = "spl-token-2022";
            packageId = "spl-token-2022 8.0.1";
            features = [ "no-entrypoint" ];
          }
          {
            name = "spl-token-group-interface";
            packageId = "spl-token-group-interface 0.6.0";
          }
          {
            name = "spl-token-metadata-interface";
            packageId = "spl-token-metadata-interface 0.7.0";
          }
          {
            name = "thiserror";
            packageId = "thiserror 2.0.12";
      ...
      "solana-account-decoder-client-types" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "1s0p34r63hvvfghm8dav0bxs3aksn61rz24s1w06xq9ykmclldgz";
      ...
      "solana-client" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0yqlm41ri9nl6af61z2grdmyr2r41zxa93yh8yvj2dvqfpar1xs2";
      ...
      "solana-connection-cache" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0jnmj92xp25phs91q925isvvfin2zrvsd1jv0xa86hbqak9iisy0";
      ...
      "solana-curve25519" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0rxj0z2c9smxa0sipcl14plyvdsbnw992spzbhv53zrlvv9f67lh";
      ...
      "solana-measure" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0jffwis5jxxg43y0l1h561id1599mm066ysdsfviwgk923k6wd4f";
      ...
      "solana-metrics" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "03b9h2nyag2905dd2i8gcc0klql12c2sfap3fm6ax17nqlqslx6f";
      ...
      "solana-net-utils" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0cv4n8y79gz86xb4c3iizyzlxb4q3mh2sizlnywnms37i6bqlgq0";
      ...
      "solana-perf" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "05h5s1wnsys3pay381rh7cggr2hl7na8prw6n9fssaibgida6hwx";
        libName = "solana_perf";
        authors = [
          "Anza Maintainers <maintainers@anza.xyz>"
        ];
      ...
      "solana-pubsub-client" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "1xnsrcl68n70dyplidlb3pv0q0cnjipm5wgiv7sg2wq8m9szasz7";
      ...
      "solana-quic-client" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "1cjf9xr97m21bd0qbcqzlmbmvazal03wxgx861l7p2bjqbpig1im";
      ...
      "solana-rayon-threadlimit" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "043lpz5qdxrspim9pcwpzlzdffy1kagy2yfkzphz9c49qpikml0r";
      ...
      "solana-rpc-client" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "1dvi1hzqwrn1339970ryqxbxccwwvnf7hwgd6cz41jxfxgfm3w2i";
      ...
      "solana-rpc-client-api" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0m38aq7slfkcp8wy7s5bksj41s8br3fb0ql40rvhnnv5v9jrjirx";
      ...
      "solana-rpc-client-nonce-utils" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "09956lnqxi4dy3bav185pqh01hlzafz24s49jm1hqvdkns0xpmr2";
      ...
      "solana-rpc-client-types" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "1bzpii0zwp1mnvsaxm5vk4jz6m57k5whnfd3y10zrc9xrnmpsv3v";
      ...
      "solana-streamer" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0ci0iilz3wanpvdr3k2kqin3y6hry3m0zyjn2aj481vrvj9pbgmg";
      ...
      "solana-svm-feature-set" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "04qh9cvqkmpkq8c6zdp7jd2h9c6252jv9b37qf62rb1dpl8z5lxk";
      ...
      "solana-thin-client" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "11gkszrll2s79wsjby90qhangwjw74x29wwglwvpg70ma17p4fhb";
      ...
      "solana-tls-utils" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0q0h82djdhvy0zfw3crpm6bswsk0y5xn8mnbl345ks0i2n89ba5q";
      ...
      "solana-tpu-client" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0615ka858qjwd0ymqh64g9qds7zz8w5812v6x2zwx1cks7afnmvb";
      ...
      "solana-transaction-context" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0as5g2j6cynkkwjwkz9fr8paj0vi3ak7548lfycpgfi2mf09kkgw";
      ...
      "solana-transaction-metrics-tracker" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0n96y95rp77gpbz1mjw9frz8knwvqrzs67as6pagl3q83y0689g0";
      ...
      "solana-transaction-status" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0azl7a53l50dxn38zpw0wqb11giwwig9ldv0pmy9ks60rkiavqdp";
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "agave-reserved-account-keys";
          }
          {
            name = "base64";
            packageId = "base64 0.22.1";
          ...
          {
            name = "spl-associated-token-account";
            packageId = "spl-associated-token-account 7.0.0";
            features = [ "no-entrypoint" ];
          }
          {
            name = "spl-memo";
      ...
      "solana-transaction-status-client-types" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "1gcvk5z28k5zdxkgj6yjz2x8jg4h5ng9qd7j0i7j9i5ng2ifviaa";
      ...
      "solana-udp-client" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0pdjmf84l88q89qcsaq5pff4f23f4plcsyz5x9sx7c9ci6073qaf";
      ...
      "solana-version" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0p159ij0j4558zwbqrbyyqzjy16445kph1vrmc9cb071sdr12vzh";
      ...
      "solana-vote-interface" = rec {
        ...
        version = "2.2.6";
        edition = "2021";
        sha256 = "1hzliah3j5y8kfkqxzmf0qd3dhiyz7kmmk1irh5d76b5im3mf3dq";
      ...
      "solana-zk-sdk" = rec {
        ...
        version = "2.3.5";
        edition = "2021";
        sha256 = "0j5dy40zzd3dm09carr8di0s243fjwijbb042qyag6zxyrf4m9v0";
      ...
      "spl-associated-token-account 6.0.0" = rec {
      ...
      "spl-associated-token-account 7.0.0" = rec {
        crateName = "spl-associated-token-account";
        version = "7.0.0";
        edition = "2021";
        sha256 = "06q4xa50abskjmn3d2hhvxx4gd2cv2pfd64qhc6a5ixk4r59s5xf";
        libName = "spl_associated_token_account";type = [ "cdylib" "lib" ];
        authors = [
          "Anza Maintainers <maintainers@anza.xyz>"
        ];
      ...
      "spl-elgamal-registry 0.1.1" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "spl-token-confidential-transfer-proof-extraction 0.2.1";
          }
        ];
        features = {
        };
      ...
      "spl-elgamal-registry 0.2.0" = rec {
        crateName = "spl-elgamal-registry";
        version = "0.2.0";
        edition = "2021";
        ...
        dependencies = [
          ...
          {
            name = "spl-token-confidential-transfer-proof-extraction";
            packageId = "spl-token-confidential-transfer-proof-extraction 0.3.0";
          }
        ];
        features = {
        };
      ...
      "spl-program-error 0.6.0" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "spl-program-error-derive 0.4.1";
          }
          {
            name = "thiserror";
            packageId = "thiserror 1.0.69";
      ...
      "spl-program-error 0.7.0" = rec {
        ...
        dependencies = [
          ...
          {
            name = "spl-program-error-derive";
            packageId = "spl-program-error-derive 0.5.0";
          }
          {
            name = "thiserror";
            packageId = "thiserror 2.0.12";
      ...
      "spl-program-error-derive 0.4.1" = rec {
      ...
      "spl-program-error-derive 0.5.0" = rec {
        crateName = "spl-program-error-derive";
        version = "0.5.0";
        edition = "2021";
      ...
      "spl-tlv-account-resolution 0.10.0" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "spl-program-error 0.7.0";
          }
          {
            name = "spl-type-length-value";
            packageId = "spl-type-length-value 0.8.0";
          }
          {
            name = "thiserror";
            packageId = "thiserror 2.0.12";
      ...
      "spl-tlv-account-resolution 0.9.0" = rec {
        crateName = "spl-tlv-account-resolution";
        version = "0.9.0";
        edition = "2021";
        ...
        dependencies = [
          ...
          {
            name = "spl-program-error";
            packageId = "spl-program-error 0.6.0";
          }
          {
            name = "spl-type-length-value";
            packageId = "spl-type-length-value 0.7.0";
          }
          {
            name = "thiserror";
            packageId = "thiserror 1.0.69";
      ...
      "spl-token-2022 6.0.0" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "spl-elgamal-registry 0.1.1";
            features = [ "no-entrypoint" ];
          }
          {
            name = "spl-memo";
          ...
          }
          {
            ...
            packageId = "spl-token-confidential-transfer-ciphertext-arithmetic 0.2.1";
          }
          {
            name = "spl-token-confidential-transfer-proof-extraction";
            packageId = "spl-token-confidential-transfer-proof-extraction 0.2.1";
          }
          {
            ...
            packageId = "spl-token-confidential-transfer-proof-generation 0.2.0";
            target = { target, features }: (!("solana" == target."os" or null));
          }
          {
            name = "spl-token-group-interface";
          ...
          }
          {
            ...
            packageId = "spl-transfer-hook-interface 0.9.0";
          }
          {
            name = "spl-type-length-value";
            packageId = "spl-type-length-value 0.7.0";
      ...
      "spl-token-2022 8.0.1" = rec {
        ...
        dependencies = [
          ...
          {
            name = "spl-elgamal-registry";
            packageId = "spl-elgamal-registry 0.2.0";
            features = [ "no-entrypoint" ];
          }
          {
            name = "spl-memo";
          ...
          {
            name = "spl-transfer-hook-interface";
            packageId = "spl-transfer-hook-interface 0.10.0";
          }
          {
            name = "spl-type-length-value";
            packageId = "spl-type-length-value 0.8.0";
      ...
      "spl-token-confidential-transfer-ciphertext-arithmetic 0.2.1" = rec {
      ...
      "spl-token-confidential-transfer-proof-extraction 0.2.1" = rec {
      ...
      "spl-token-confidential-transfer-proof-extraction 0.3.0" = rec {
        crateName = "spl-token-confidential-transfer-proof-extraction";
        version = "0.3.0";
        edition = "2021";
      ...
      "spl-token-confidential-transfer-proof-generation 0.2.0" = rec {
      ...
      "spl-token-group-interface 0.5.0" = rec {
      ...
      "spl-token-group-interface 0.6.0" = rec {
        crateName = "spl-token-group-interface";
        version = "0.6.0";
        edition = "2021";
      ...
      "spl-token-metadata-interface 0.6.0" = rec {
      ...
      "spl-token-metadata-interface 0.7.0" = rec {
        crateName = "spl-token-metadata-interface";
        version = "0.7.0";
        edition = "2021";
      ...
      "spl-transfer-hook-interface 0.10.0" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "spl-tlv-account-resolution 0.10.0";
          }
          {
            name = "spl-type-length-value";
            packageId = "spl-type-length-value 0.8.0";
      ...
      "spl-transfer-hook-interface 0.9.0" = rec {
        crateName = "spl-transfer-hook-interface";
        version = "0.9.0";
        edition = "2021";
        ...
        dependencies = [
          ...
          {
            name = "spl-tlv-account-resolution";
            packageId = "spl-tlv-account-resolution 0.9.0";
          }
          {
            name = "spl-type-length-value";
            packageId = "spl-type-length-value 0.7.0";
      ...
      "spl-type-length-value 0.7.0" = rec {
      ...
      "spl-type-length-value 0.8.0" = rec {
        crateName = "spl-type-length-value";
        version = "0.8.0";
        edition = "2021";
      ...
      "valence-core" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./programs/valence-core; };
        libName = "valence_core";type = [ "cdylib" "lib" ];
        dependencies = [
          {
            name = "anchor-lang";
            packageId = "anchor-lang";
      ...
      "valence-functions" = rec {
        crateName = "valence-functions";
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./programs/valence-functions; };
        libName = "valence_functions";type = [ "cdylib" "lib" ];
        dependencies = [
          {
            name = "anchor-lang";
            packageId = "anchor-lang";
      ...
      "valence-registry" = rec {
        crateName = "valence-registry";
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/registry; };
        libName = "valence_registry";
        dependencies = [
          {
            name = "anchor-lang";
            packageId = "anchor-lang";
      ...
      "valence-runtime" = rec {
        crateName = "valence-runtime";
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/runtime; };
        libName = "valence_runtime";
        authors = [
          "Valence Contributors"
        ];
        dependencies = [
      ...
      "valence-sdk" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/sdk; };
        libName = "valence_sdk";
        dependencies = [
          {
            name = "anchor-client";
      ...
      "webpki-root-certs 0.26.11" = rec {
        ...
        dependencies = [
          {
            name = "webpki-root-certs";
            packageId = "webpki-root-certs 1.0.2";
            rename = "parent";
          }
        ];

      };
      "webpki-root-certs 1.0.2" = rec {
        crateName = "webpki-root-certs";
        version = "1.0.2";
        edition = "2021";
        sha256 = "0ami487nawf5m8ji28rsviwm5drxz5p3s2h04p1qfzn5y66zsksf";
        libName = "webpki_root_certs";
        dependencies = [
          {
            name = "rustls-pki-types";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "processenv" "processthreadsapi" "profileapi" "sysinfoapi" "winbase" "winerror" "winnt" ];
      };
