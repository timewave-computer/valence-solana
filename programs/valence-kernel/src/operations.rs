...
pub enum KernelOperation {
    ...
    /// Custom operation for shard extensions
...
impl KernelOperation {
    ...
    pub fn validate(&self) -> Result<()> {
        match self {
            Self::CallProgram { data, account_indices, .. } => {
    ...
    pub fn requires_write(&self) -> bool {
        !matches!(self, Self::CallProgram { .. }) // All except CallProgram need write
    }
...
pub struct KernelOperationBatch {
    ...
    pub program_manifest: Vec<CpiProgramEntry>,
}

impl KernelOperationBatch {
    ...
    pub fn create(operations: Vec<KernelOperation>, program_manifest: Vec<CpiProgramEntry>) -> Self {
        Self {
            operations,
            auto_release: true,
            program_manifest,
