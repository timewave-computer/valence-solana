...
// Import via declare_program! to avoid macro issues
pub mod program;
pub use program::valence_core::*;
use valence_core::*;
...
impl TestContext {
    pub async fn new() -> Self {
        let program_id = valence_core::ID;
        let mut program_test = ProgramTest::new(
            "valence_core",
            program_id,
            anchor_lang::solana_program::entrypoint!(valence_core),
        );
    ...
    pub async fn initialize_program(&mut self) -> Result<()> {
        let ix = Instruction {
            ...
            accounts: valence_core::accounts::Initialize {
                authority: self.authority.pubkey(),
                system_program: system_program::ID,
            }
            .to_account_metas(None),
            data: valence_core::instruction::Initialize {}.data(),
        };
    ...
    pub async fn initialize_allowlist(&mut self, allowlist: &Keypair) -> Result<()> {
        ...
        let space = 8 + std::mem::size_of::<CPIAllowlist>();
        ...
        let initialize_ix = Instruction {
            program_id: self.program_id,
            accounts: valence_core::accounts::InitializeAllowlist {
                cpi_allowlist: allowlist.pubkey(),
                authority: self.payer.pubkey(),
                system_program: system_program::ID,
            }
            .to_account_metas(None),
            data: valence_core::instruction::InitializeAllowlist {}.data(),
        };
    ...
    pub async fn add_to_allowlist(
        ...
        let ix = Instruction {
            program_id: self.program_id,
            accounts: valence_core::accounts::ManageAllowlist {
                cpi_allowlist: allowlist.pubkey(),
                authority: self.payer.pubkey(),
            }
            .to_account_metas(None),
            data: valence_core::instruction::AddToAllowlist { program_id }.data(),
        };
    ...
    pub async fn remove_from_allowlist(
        ...
        let ix = Instruction {
            ...
            .to_account_metas(None),
            data: valence_core::instruction::RemoveFromAllowlist { program_id }.data(),
        };
    ...
    pub async fn create_guard_data(
        ...
        let rent = self.banks_client.get_rent().await.unwrap();
        let space = GuardData::space_for_compiled_guard(&compiled_guard);
        let lamports = rent.minimum_balance(space);
        ...
        let create_guard_ix = Instruction {
            program_id: self.program_id,
            accounts: valence_core::accounts::CreateGuardData {
                guard_data: guard_data.pubkey(),
                payer: self.payer.pubkey(),
                system_program: system_program::ID,
            }
            .to_account_metas(None),
            data: valence_core::instruction::CreateGuardData {
                session,
                compiled_guard,
            }
            .data(),
    ...
    pub async fn create_session(
        ...
        let create_session_ix = Instruction {
            program_id: self.program_id,
            accounts: valence_core::accounts::CreateSession {
                session: session.pubkey(),
                owner: self.payer.pubkey(),
                system_program: system_program::ID,
            }
            .to_account_metas(None),
            data: valence_core::instruction::CreateSession {
                protocol,
                params,
            }
            .data(),
        ...
        self.send_transaction(
            &[create_account_ix, create_session_ix],
            &[&self.payer, session],
        ).await
    }
    ...
    pub async fn execute_operations(
        ...
        let mut account_metas = valence_core::accounts::ExecuteOperations {
            session: session.pubkey(),
            guard_data: guard_data.pubkey(),
            cpi_allowlist: allowlist.pubkey(),
        ...
        let ix = Instruction {
            ...
            data: valence_core::instruction::ExecuteOperations { batch }.data(),
        };
...
pub use valence_core::{MODE_READ, MODE_WRITE, MODE_READ_WRITE};
pub use valence_core::validation::{MAX_CPI_DATA_SIZE, MAX_CUSTOM_DATA_SIZE};