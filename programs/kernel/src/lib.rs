...
declare_id!("Va1enceKerne1111111111111111111111111111111");

// Kernel program modules
...
// Re-exports for kernel types (specific imports to avoid conflicts)
...
pub mod kernel {
    ...
    /// Initialize the kernel shard with eval capabilities
    pub fn initialize(
