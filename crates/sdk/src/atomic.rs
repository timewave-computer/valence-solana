...
use valence_core::operations::{OperationBatch, SessionOperation, ProgramManifestEntry};
...
impl<'a> AtomicBuilder<'a> {
    ...
    #[deprecated(note = "Use build_batch() and execute_operations_instruction instead")]
    pub fn build_instruction(&self) -> Result<Instruction> {
        ...
        unimplemented!("Use build_batch() separately and then execute_operations_instruction")
    }
